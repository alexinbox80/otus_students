...
class Controller
{
    ...
    #[Route(
        path: 'api/v1/get-students-grade-for-skill-async',
        name: 'web_get_students_by_grade_for_skill_async_v1_invoke',
        methods: ['GET']
    )]
    public function __invoke(): StudentsGradeAsyncDTO
    {
        return $this->manager->getStudentGradeForSkillAsync();
    }
}
